...
export default function SignUp({ signupHandler }) {
  ...
  return (
    <div className="rounded-2xl m-auto signModal" style={{ height: "35rem" }}>
      ...
      <form onSubmit={handleSubmit} className="m-auto my-4 w-60 relative">
        <label className="block m-auto mt-6">
          ...
          <input
            className=" w-60 border border-solid border-neutral-300 focus: focus:border-solid focus:border-neutral-300 h-8"
            name="email"
            type="text"
